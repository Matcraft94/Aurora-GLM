...
from aurora.distributions.links import SqrtLink, PowerLink, InverseSquareLink
...
class TestStudentTFamily:
    ...
    def test_scale_estimation_robust(self):
        ...
        scale_clean = family.estimate_scale(y_clean, mu_clean)
...
class TestFamilyIntegration:
    ...
    @pytest.mark.parametrize("FamilyClass,kwargs", [
    ...
    @pytest.mark.parametrize("FamilyClass,kwargs,y", [
