...
def test_random_effect_slope_only():
    ...
    re = RandomEffect(grouping="subject", variables=("time",), include_intercept=False)
...
def test_random_effect_no_effects_raises():
    ...
    with pytest.raises(ValueError, match="must include either intercept"):
        RandomEffect(grouping="subject", variables=(), include_intercept=False)
...
def test_count_random_effects_no_intercept():
    ...
    re = RandomEffect(grouping="subject", variables=("time", "age"), include_intercept=False)
